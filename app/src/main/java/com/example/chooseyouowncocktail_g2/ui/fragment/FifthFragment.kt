...
import com.example.chooseyouowncocktail_g2.databinding.FragmentFifthBinding
...
class FifthFragment : Fragment()  {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.buttonFifth4.setOnClickListener {
            var soundPellican= MediaPlayer.create(getActivity(), com.example.chooseyouowncocktail_g2.R.raw.pellican)
            //suo.setLooping(true);
            soundPellican.start();
