...
import com.example.chooseyouowncocktail_g2.databinding.FragmentSixthBinding
...
class SixthFragment : Fragment()  {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.buttonSixth4.setOnClickListener {
            val soundOwl = MediaPlayer.create(getActivity(), com.example.chooseyouowncocktail_g2.R.raw.owl)
            soundOwl.setLooping(true);
            soundOwl.start();
        }
