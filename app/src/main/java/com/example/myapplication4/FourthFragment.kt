...
import com.example.myapplication4.databinding.FragmentFourthBinding
...
class FourthFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.buttonFourth4.setOnClickListener {
            var soundFalcon = MediaPlayer.create(getActivity(), com.example.myapplication4.R.raw.falcon)
            //suo.setLooping(true);
            soundFalcon.start();
